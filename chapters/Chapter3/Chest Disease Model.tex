...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, height=4cm, keepaspectratio=false]{assets/chest6.jpg}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, height=4cm, keepaspectratio=false]{assets/chest7.jpg}
	\end{subfigure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, height=4cm, keepaspectratio=false]{assets/chest8.jpg}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, height=4cm, keepaspectratio=false]{assets/chest9.png}
	\end{subfigure}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, height=6cm, keepaspectratio=false]{assets/chest13.png}
		\caption{Original}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, height=6cm, keepaspectratio=false]{assets/chest11.jpeg}
		\caption{Binary Mask}
	\end{subfigure}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, height=6cm, keepaspectratio=false]{assets/chest15.png}
...
For more information regarding the DenseNet121 architecture used refer to Section~\ref{sec:densenet121}
\newpage
