...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.95\linewidth]{assets/backend-1.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.95\linewidth]{assets/backend-2.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.95\linewidth]{assets/backend18.png}
...
The various key types and their roles are shown and explained in great detail in Table~\ref{tab:f1_keys}.
