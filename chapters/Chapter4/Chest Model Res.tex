...
\begin{table}[htbp]
	...
	\begin{tabularx}{0.85\textwidth}{|X|l|}
		...
		Batch size & 32 \\
		\hline
		Early stopping & patience=5, monitor=val\_accuracy \\
		\hline
		LR reduction & ReduceLROnPlateau (factor=0.2, patience=3) \\
		\hline
